	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_8zvbcpc_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
			...
			{
				"operation": "insert",
				"name": "MenuItem_1ttkz2t",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_1ttkz2t_caption)#",
					"visible": true,
					"clicked": {
			...
			},
			{
				...
				"values": {
					...
					"placeholder": "",
					"tooltip": "",
					"valueDetails": "$UsrType_ValueDetails"
				},
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_lved7om;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_fl8l850;
					var offerTypeId = "";
					if (offerTypeObject) {
