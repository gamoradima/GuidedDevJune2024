namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("1d93c14e-77b7-4afe-bfe1-4f3146750cbb");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("59778deb-71e7-ecb4-684f-4626920e3fed"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("7b6e4cca-fa78-4a0b-a380-1b8afee3e23d"),
				CreatedInSchemaUId = new Guid("1d93c14e-77b7-4afe-bfe1-4f3146750cbb"),
				ModifiedInSchemaUId = new Guid("1d93c14e-77b7-4afe-bfe1-4f3146750cbb")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("1d93c14e-77b7-4afe-bfe1-4f3146750cbb"));
		}
